...
// ===== FUNCIONALIDAD DEL LOGO - SCROLL AL INICIO =====
class LogoScrollHandler {
    constructor() {
        this.logo = $('.nav__logo');
        this.init();
    }
    ...
    init() {
        ...
        // Agregar funcionalidad de click al logo
        ...
        // Mejorar la accesibilidad del logo
        this.logo.setAttribute('role', 'button');
        this.logo.setAttribute('aria-label', 'Ir al inicio de la página');
        this.logo.setAttribute('tabindex', '0');
        
        console.log('🎯 Logo scroll handler inicializado');
    }
    ...
    handleLogoClick(e) {
        ...
        console.log('🔝 Navegando al inicio de la página');
    }

    addClickFeedback() {
        // Agregar una clase temporal para feedback visual
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    new MobileNav();
    new LogoScrollHandler(); // ¡Nueva funcionalidad del logo!
    ...
    console.log('🎯 Logo ahora navega al inicio al hacer clic');
});
