          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-purple-100 mt-1 text-xl">
                  {roleInfo?.full_name || user.full_name}
                </p>
            ...
            <div className="text-right">
              <p className="text-purple-100 text-sm">Miembro</p>
              {user.parent_club && (
                <p className="text-white font-semibold">{user.parent_club.name}</p>
              )}
              {user.parent_club?.league && (
                <p className="text-purple-200 text-sm">{user.parent_club.league.name}</p>
              )}
            </div>
          </div>
        </div>
