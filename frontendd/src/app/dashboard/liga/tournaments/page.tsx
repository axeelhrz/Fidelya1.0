...
export default function LigaTournamentsPage() {
  ...
  const [newTournament, setNewTournament] = useState<TournamentForm>({
    name: '',
    description: '',
    league_id: user?.leagueEntity?.id || 0,
    sport_id: 0,
    start_date: '',
    end_date: '',
        ...
        <div className="bg-gradient-to-r from-yellow-50 to-yellow-100 border border-yellow-200 rounded-lg p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h2 className="text-xl font-semibold text-gray-900">{user?.leagueEntity?.name}</h2>
                <p className="text-gray-600">Provincia: {user?.leagueEntity?.province}</p>
            ...
            <div className="text-right">
              <p className="text-sm text-gray-500">Liga desde</p>
              <p className="font-medium text-gray-900">
                {user?.leagueEntity?.created_at ? new Date(user.leagueEntity.created_at).toLocaleDateString() : 'N/A'}
              </p>
            </div>
          </div>
        </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setNewTournament(prev => ({ ...prev, entry_fee: parseFloat(e.target.value) }))}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setNewTournament(prev => ({ ...prev, prize_pool: parseFloat(e.target.value) }))}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent"
                      />
                    </div>
