...
const config: Config = {
  ...
  safelist: [
    // Clases personalizadas que siempre deben incluirse
    'bg-grid',
    'glass',
    'glass-card',
    'glass-button',
    ...
    {
      pattern: /^(from|via|to)-(primary|slate|violet|success|warning|error)-(50|100|200|300|400|500|600|700|800|900|950)$/,
    },
  ],
  plugins: [],
}
