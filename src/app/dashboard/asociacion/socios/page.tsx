...
function SociosPageContent() {
  ...
  const getPageDescription = () => {
    switch (filter) {
      case 'activos':
        return 'Administra y supervisa tu comunidad de miembros - Vista: Socios Activos';
      case 'vencidos':
        return 'Administra y supervisa tu comunidad de miembros - Vista: Socios Vencidos';
      default:
