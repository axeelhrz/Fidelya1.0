...
export default function OptimizedAsociacionDashboard() {
  ...
  // Enhanced navigation handler with better debugging
  const handleNavigate = useCallback((section: string) => {
    console.log('Dashboard navigation to:', section); // Debug log
    setCurrentSection(section);
  }, []);

  // Enhanced add member handler that properly triggers the new socio dialog
  const handleAddMember = useCallback(() => {
    console.log('Dashboard add member triggered'); // Debug log
    
    // Set the current section to socios first
    setCurrentSection('socios');
    
    // Then trigger the new socio dialog with a slight delay to ensure the tab is loaded
    setTimeout(() => {
  ...
  const handleNewSocioTriggered = useCallback(() => {
    console.log('New socio dialog triggered, resetting trigger'); // Debug log
