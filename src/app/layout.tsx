  ...
  if (!mounted) {
    return (
      <html lang="es" className={inter.variable}>
        <head>
          <title>Fidelita - Plataforma de Fidelización Inteligente</title>
          <meta name="description" content="La plataforma que conecta asociaciones, comercios y socios en un ecosistema único de beneficios mutuos. Fidelización moderna y eficaz." />
          <meta name="keywords" content="fidelización, loyalty, comercios, asociaciones, socios, beneficios" />
