...
export class AlertService {
  ...
  static async detectSymptomsInSession(
    ...
    try {
      ...
      try {
        ...
        console.warn('AI analysis not available, using keyword detection only:', aiError);
      }
    } catch (error) {
  ...
  static async getAlertStats(centerId: string): Promise<AlertStats> {
    try {
      // Usar el método del FirestoreService que ya implementa AlertStats correctamente
