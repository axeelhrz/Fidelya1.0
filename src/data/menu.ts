  ...
  'xs-reset-menu': {
    ...
    products: [
      ...
      },
      {
        ...
        price: 4500,
        description: 'Bondiola de cerdo desmenuzada, cebolla morada, chimichurri, pan brioche',
        category: 'Platos Principales',
        isRecommended: false,
        isVegan: false,
      },
      {
        ...
        price: 4200,
        description: 'Lechuga romana, pollo grillado, crutones, parmesano, aderezo caesar',
        category: 'Platos Principales',
        isRecommended: false,
        isVegan: false,
      },
      {
        ...
        price: 3800,
        description: 'Tortilla integral, hummus, vegetales asados, queso feta, aceitunas',
        category: 'Platos Principales',
        isRecommended: true,
        isVegan: false,
      },
      ...
      },
      {
        ...
        price: 3200,
        description: 'Mascarpone, café espresso, cacao en polvo, bizcochos de soletilla',
        category: 'Postres',
        isRecommended: false,
        isVegan: false,
      },
      {
        ...
        price: 3800,
        description: 'Base de galleta, queso crema, coulis de frutos rojos',
        category: 'Postres',
        isRecommended: false,
        isVegan: false,
      },
      ...
      },
      {
        ...
        price: 2000,
        description: 'Leche vaporizada con shot de espresso y espuma de leche',
        category: 'Cafetería',
        isRecommended: false,
        isVegan: false,
      },
      {
        ...
        name: 'Té Premium',
        price: 1500,
        description: 'Selección de tés: Earl Grey, English Breakfast, Manzanilla, Verde',
        category: 'Cafetería',
        isRecommended: false,
        isVegan: true,
      },
