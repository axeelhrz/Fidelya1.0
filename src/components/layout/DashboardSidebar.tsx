          ...
          <ListItem disablePadding sx={{ mb: 1.5 }}>
            <ListItemButton
              ...
              sx={{
                ...
                border: isActive ? 'none' : `2px solid ${alpha(item.color, 0.15)}`,
                transition: 'all 0.4s cubic-bezier(0.4, 0, 0.2, 1)',
                '&:hover': {
                  background: isActive ? item.gradient : alpha(item.color, 0.1),
                  border: `2px solid ${item.color}`,
                  transform: 'translateY(-2px)',
                  boxShadow: `0 8px 25px ${alpha(item.color, isActive ? 0.4 : 0.15)}`,
                },
                '&::before': {
                  content: '""',
                  position: 'absolute',
                ...
                <Badge 
                  ...
                  sx={{
                    '& .MuiBadge-badge': {
                      ...
                      border: isActive ? `1px solid ${alpha('#ffffff', 0.3)}` : 'none',
                      top: -2,
                      right: -2,
                    }
                  }}
          ...
          >
            <ListItemButton
              ...
              sx={{
                ...
                border: isActive ? 'none' : `1px solid ${alpha(item.color, 0.1)}`,
                transition: 'all 0.4s cubic-bezier(0.4, 0, 0.2, 1)',
                '&:hover': {
                  background: isActive ? item.gradient : alpha(item.color, 0.08),
                  color: isActive ? 'white' : item.color,
                  transform: 'translateX(4px)',
                  boxShadow: `0 6px 20px ${alpha(item.color, isActive ? 0.4 : 0.15)}`,
