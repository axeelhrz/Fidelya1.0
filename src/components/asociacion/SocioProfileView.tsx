...
import { EnhancedDialog, DialogContent, DialogHeader, DialogTitle, DialogDescription } from '@/components/ui/EnhancedDialog';
...
export const SocioProfileView: React.FC<SocioProfileViewProps> = ({
  ...
  return (
    <EnhancedDialog open={open} onClose={onClose} size="xl" className="max-w-4xl">
      {/* Header con gradiente */}
      <DialogHeader gradient className="bg-gradient-to-r from-blue-600 to-indigo-600">
